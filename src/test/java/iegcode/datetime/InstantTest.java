...
public class InstantTest {
    ...
    void get() {
        ...
        System.out.println(instant.toEpochMilli()); // waktu dalam milisecond
        System.out.println(instant.getEpochSecond()); //  waktu dalam bentuk second
