...
public class TemporalTest {
    ...
    @Test // temporal itu keturunan seperti dari data dan waktu
    void temporal() {
    ...
    @Test // penambahan / pengurangan tanggal dan waktu
    void temporalAmount() {
    ...
    @Test // temporal unit satu waktu / menghitung durasi waktu
    void temporalUnit() {
    ...
    @Test // field dalam sebuah tipe data
    void temporalField() {
    ...
    @Test // MENGAMBIL INFORMASI DARI DATA TEMPORALACCESSOR
    ...
    @Test // mempermudah penyesuaian object
