...
public class DurationTest {
    ...
    void ger() {
        ...
        Duration duration = Duration.ofHours(65);
    ...
    @Test // menghitung duration
    void between() {

        Duration duration1 = Duration.between(LocalDateTime.now(), LocalDateTime.now().plusHours(65));
        System.out.println(duration1.toHours());
        System.out.println(duration1.toMinutes());

        Duration duration2 = Duration.between(LocalDateTime.now().plusHours(65), LocalDateTime.now());
